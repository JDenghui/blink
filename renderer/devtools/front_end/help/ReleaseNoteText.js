    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools#network-search',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools#vars',
      },
      {
        title: 'Stop infinite loops',
        subtitle: 'Pause JavaScript execution then select the new Stop Current JavaScript Call button.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools#stop',
      },
      {
        title: 'Copy as fetch',
        subtitle: 'Right-click a network request then select Copy > Copy as fetch.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools#fetch',
      },
      {
        title: 'More audits',
        subtitle: 'Two new audits, desktop configuration options, and viewing traces.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools#audits',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools#tabs',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/04/devtools',
  },
  {
    version: 9,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/02/devtools#pretty-printing',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/02/devtools#previews',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/02/devtools#overrides',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/02/devtools#blackboxing',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/02/devtools',
  },
  {
    version: 8,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools#overrides',
      },
      {
        title: 'Changes tab',
        subtitle: 'Track changes that you make locally in DevTools via the Changes tab.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools#changes',
      },
      {
        title: 'New accessibility tools',
        subtitle: 'Inspect the accessibility properties and contrast ratio of elements.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools#a11y',
      },
      {
        title: 'New audits',
        subtitle: 'New performance audits, a whole new category of SEO audits, and more.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools#audits',
      },
      {
        title: 'Code stepping updates',
        subtitle: 'Reliably step into web worker and asynchronous code.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools#stepping',
      },
      {
        title: 'Multiple recordings in the Performance panel',
        subtitle: 'Temporarily save up to 5 recordings.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools#recordings',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/01/devtools',
  },
  {
    version: 7,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/11/devtools-release-notes#perf-monitor',
      },
      {
        title: 'Console sidebar',
        subtitle: 'Reduce console noise and focus on the messages that are important to you.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/11/devtools-release-notes#console-sidebar',
      },
      {
        title: 'Group similar console messages',
        subtitle: 'The Console now groups similar messages by default.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/11/devtools-release-notes#group-similar',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/11/devtools-release-notes',
  },
  {
    version: 6,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/10/devtools-release-notes#multi-client',
      },
      {
        title: 'Workspaces 2.0',
        subtitle: 'Save changes made in DevTools to disk, now with more helpful UI and better auto-mapping.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/10/devtools-release-notes#workspaces',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/10/devtools-release-notes#audits',
      },
      {
        title: 'Custom push notifications',
        subtitle: 'Simulate push notifications with custom data.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/10/devtools-release-notes#push',
      },
      {
        title: 'Custom background sync events',
        subtitle: 'Trigger background sync events with custom tags.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/10/devtools-release-notes#sync',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/10/devtools-release-notes',
  },
  {
    version: 5,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#await',
      },
      {
        title: 'New screenshot workflows',
        subtitle: 'Take screenshots of a portion of the viewport, or of specific HTML nodes.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#screenshots',
      },
      {
        title: 'CSS Grid highlighting',
        subtitle: 'Hover over an element to see the CSS Grid that\'s affecting it.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#css-grid-highlighting',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#query-objects',
      },
      {
        title: 'New Console filters',
        subtitle: 'Filter out logging noise with the new negative and URL filters.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#console-filters',
      },
      {
        title: 'HAR imports in the Network panel',
        subtitle: 'Drag-and-drop a HAR file to analyze a previous network recording.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#har-imports',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes#cache-preview',
      }
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/08/devtools-release-notes',
  },
  {
    version: 4,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/07/devtools-release-notes#throttling',
      },
      {
        title: 'Storage usage',
        subtitle: 'See how much storage (IndexedDB, local, session, cache, etc.) an origin is using.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/07/devtools-release-notes#storage',
      },
      {
        title: 'Cache timestamps',
        subtitle: 'View when a service worker cached a response.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/07/devtools-release-notes#time-cached',
      },
      {
        title: 'ES6 Modules support',
        subtitle: 'Debug ES6 Modules natively from the Sources panel.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/07/devtools-release-notes#modules',
      }
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/07/devtools-release-notes',
  },
  {
    version: 3,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes#lighthouse',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes#badges',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes#continue',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes#step-into-async',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes#object-previews',
      },
      {
        title: 'Real-time Coverage tab updates',
        subtitle: 'See what code is being used in real-time.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes#coverage',
      }
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/05/devtools-release-notes',
  },
  {
    version: 2,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/04/devtools-release-notes#coverage',
      },
      {
        title: 'Full-page screenshots',
        subtitle: 'Take a screenshot of the entire page, from the top of the viewport to the bottom.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/04/devtools-release-notes#screenshots',
      },
      {
        title: 'Block requests',
        subtitle: 'Manually disable individual requests in the Network panel.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/04/devtools-release-notes#block-requests',
      },
      {
        title: 'Step over async await',
        subtitle: 'Step through async functions predictably.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/04/devtools-release-notes#async',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/04/devtools-release-notes#command-menu',
      }
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/04/devtools-release-notes',
  },
  {
    version: 1,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/03/devtools-release-notes#performance-panel',
      },
      {
        title: 'Editable cookies',
        subtitle: 'You can edit any existing cookies and create new ones in the Application panel',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/03/devtools-release-notes#cookies',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/03/devtools-release-notes#console',
      },
      {
        title: 'Debugger catches out-of-memory errors',
        subtitle: 'See the stack or grab a heap snapshot to see why the app may crash',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/03/devtools-release-notes#out-of-memory-breakpoints',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2017/03/devtools-release-notes',
  }
];
